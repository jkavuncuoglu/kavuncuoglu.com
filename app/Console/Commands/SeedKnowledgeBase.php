    ...
    protected function getDocuments(): array
    {
        return [
            ...
            [
                ...
                'type' => 'bio',
                'content' => <<<EOT
Jeremy Kavuncuoglu is a Senior Full-Stack Developer and AWS Cloud Platform Engineer with over 10 years of professional experience. He specializes in Laravel, Vue.js, AWS infrastructure ownership, Amazon Connect integrations, and DevOps automation. He has designed and maintained production AWS environments including EC2, Auto Scaling Groups, CodePipeline, CodeBuild, CodeDeploy, Terraform, IAM, VPC, SSM, CloudWatch, Lambda, RDS, Redis, S3, Redshift, and ElastiCache. He delivers scalable, secure, and cost-efficient cloud systems for enterprise teams and has achieved measurable outcomes including $30,000/year in infrastructure savings and 40% performance improvements.
EOT,
                'source' => 'bio',
            ],
            [
                ...
                'type' => 'bio',
                'content' => <<<EOT
Jeremy Kavuncuoglu acts as both a senior full-stack engineer and cloud infrastructure owner. At Pleio Inc he served as the sole AWS Platform Owner, managing production systems end-to-end: EC2, ASGs, VPC, IAM, CodePipeline, CodeBuild, CodeDeploy, Terraform, SSM, and CloudWatch. His work spans CI/CD pipeline design, blue/green and canary deployments, Terraform infrastructure as code, security hardening (HIPAA, HITRUST, SOC 2), and backend performance optimization. He has experience in startups and enterprise organizations and brings a holistic approach covering architecture, DevOps, security, and delivery.
EOT,
                'source' => 'bio',
                'chunk_index' => 1,
            ],
