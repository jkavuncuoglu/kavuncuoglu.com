...
<template>
    <section
        id="skills"
        class="bg-[#f9f9f8]/80 px-6 py-24 dark:bg-[#0f0f0f]/80"
    >
        <div class="mx-auto max-w-6xl">
            ...
            <div class="mb-10 flex justify-center">
                <div
                    class="inline-flex rounded-full bg-[#f4f4f2] p-1 dark:bg-[#1f1f1f]"
                >
                    <button
            ...
            >
                ...
                >
                    ...
                    <p
                        class="mb-4 text-xs leading-relaxed text-[#706f6c] dark:text-[#A1A09A]"
                    >
                        {{ skill.desc }}
                    </p>
        ...
        <Dialog v-model:open="skillDialogOpen">
            <DialogContent class="max-w-lg">
                <DialogHeader>
                    ...
                    <DialogDescription
                        class="text-left text-sm leading-relaxed text-[#706f6c] dark:text-[#A1A09A]"
                    >
                        {{ selectedSkill?.desc }}
                    </DialogDescription>
                </DialogHeader>
                ...
                <div v-if="selectedSkill?.items?.length" class="mt-2">
                    <p
                        class="mb-3 text-xs font-medium uppercase tracking-wider text-[#706f6c] dark:text-[#A1A09A]"
                    >
                        Technologies
                    </p>
                    <div class="flex flex-wrap gap-3">
                        ...
                        >
                            ...
                            <span
                                class="max-w-[52px] text-center text-[10px] leading-tight text-[#706f6c] dark:text-[#A1A09A]"
                                >{{ item.name }}</span
                            >
                        </div>
                    </div>
